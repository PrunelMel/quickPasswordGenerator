...
<html lang="en" style="overflow-y: hidden;">
    ...
    <body class="w-full bg-blue-700 h-screen">
        ...
        <footer class="bg-white text-blue-700 ">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" class="flex items-center">
                        <img src="/assets/flash-sale-ecommerce-2-svgrepo-com.svg" class="h-8 me-3" alt="FlowBite Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap text-blue-700">HM</span>
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-blue-700 hover:text-blue-900 uppercase">Resources</h2>
                    ...
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-blue-700 uppercase hover:text-blue-900">Follow us</h2>
                        <ul class="font-medium">
                            <li class="mb-4">
            ...
            <div class="sm:flex sm:items-center text-blue-900 sm:justify-between">
                <span class="text-sm text-blue-700 sm:text-center">© 2023 <a href="https://flowbite.com/" class="hover:underline">HM™</a>. All Rights Reserved.
                </span>
