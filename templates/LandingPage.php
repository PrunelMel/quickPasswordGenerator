...
<body class="bg-black text-gray-300">
    ...
    <section class="bg-black py-20">
        <div class="container mx-auto text-center">
            <h2 class="text-3xl font-bold text-violet-400 mb-10">Pourquoi Choisir PasswordGen?</h2>
    ...
    <footer class="bg-gray-900 text-gray-400 py-8">
        <div class="container mx-auto text-center">
            <p>&copy; 2024 PasswordGen. Tous droits réservés.</p>
            <div class="mt-4">
                <a href="#" class="text-gray-500 hover:text-violet-400 mx-2">Facebook</a>
                <a href="#" class="text-gray-500 hover:text-violet-400 mx-2">Twitter</a>
                <a href="#" class="text-gray-500 hover:text-violet-400 mx-2">LinkedIn</a>
            </div>
        </div>
    </footer>
